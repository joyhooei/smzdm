...
# class:
#-keepclassmembers class fqcn.of.javascript.interface.for.webview_ui {
#   public *;
#}
...
-keepclassmembers enum * {  # 使用 enum 类型时需要注意避免以下两个方法混淆，因为 enum 类的特殊性，以下两个方法会被反射调用，
...
#app
-keep public class com.ppjun.android.smzdm.mvp.model.entity.main.**{*;}
