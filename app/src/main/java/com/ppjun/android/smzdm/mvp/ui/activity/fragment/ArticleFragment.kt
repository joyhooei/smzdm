...
import com.ppjun.android.smzdm.di.component.DaggerArticleListComponent
...
class ArticleFragment : BaseFragView<ArticleListPresenter>(), ArticleListContract.View {
        ...
        if (mPaginate == null) {
            val callbacks = object : Paginate.Callbacks {
                override fun onLoadMore() {
                    mPresenter.requestArticleList(false)
                }
